...
CAP_START_LAYERS=(1 8 17 26 35)
GROUPING_PROTOCOLS=(sum mean max)

for SEED in 42 60; do
  for MODEL_NAME in "${MODELS[@]}"; do
    for CONFIG in "${CONFIGS[@]}"; do
      ...
      for INTERVENTION_PCT in "${INTERVENTION_PCTS[@]}"; do
        ...
        MODEL_PATH="./models/GPT2_large/${DATASET_NAME}/GPT2_large_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}.pt"

        CORRECT_PRED_PATH="./results/GPT2_large_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}/${DATASET_NAME}/test_results/GPT2_large_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}_${DATASET_NAME}_test_results.json"
