  ...
  for MODEL_NAME in "${MODELS[@]}"; do
    for CONFIG in "${CONFIGS[@]}"; do
      ...
      for INTERVENTION_PCT in "${INTERVENTION_PCTS[@]}"; do
        ...
        MODEL_PATH="./models/Qwen2_5_3B/${DATASET_NAME}/Qwen2_5_3B_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}.pt"

        CORRECT_PRED_PATH="./results/Qwen2_5_3B_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}/${DATASET_NAME}/test_results/Qwen2_5_3B_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}_${DATASET_NAME}_test_results.json"
