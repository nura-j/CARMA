  ...
  for MODEL_NAME in "${MODELS[@]}"; do
    for CONFIG in "${CONFIGS[@]}"; do
      ...
      for INTERVENTION_PCT in "${INTERVENTION_PCTS[@]}"; do
        ...
        MODEL_PATH="./models/${MODEL_NAME}/${DATASET_NAME}/${MODEL_NAME}_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}.pt"

        CORRECT_PRED_PATH="./results/${MODEL_NAME}_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}/${DATASET_NAME}/test_results/${MODEL_NAME}_tw_carma_tuned_${SAFE_CARMA_WEIGHT}_st_${SAFE_STABILITY_WEIGHT}_mi_${SAFE_MI_WEIGHT}_seed_${SEED}_${DATASET_NAME}_test_results.json"
